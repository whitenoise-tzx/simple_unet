...
from utils.losses import BoundaryLoss, GeneralizedDice, L1Loss, L2Loss, DiceLoss
...
def run_main(args):
    ...
    if need_to_train:
        ...
        if args.redo_metric:
            ...
            trainer.load_checkpoints('/shared/home/v_zixin_tang/unet_nest/tensorboard_runs/seed-5-lr-0.001-batch_size-4/ckpt-epoch157.pth',args.device)
            #trainer.save_metric(log_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dic_train_gt_dir", type=str, default="/shared/home/v_zixin_tang/dataset/HK2_crop/raw_train_gt.npy")
    #parser.add_argument("--phase_train_img_dir", type=str, default="/shared/home/v_zixin_tang/dataset/NMuMg_crop/transferTrain.npy")
    parser.add_argument("--dic_train_img_dir", type=str, default="/shared/home/v_zixin_tang/dataset/HK2_crop/raw_train.npy")
    parser.add_argument("--dic_test_gt_dir", type=str, default="/shared/home/v_zixin_tang/dataset/HK2_crop/raw_test_gt.npy")
    parser.add_argument("--dic_test_img_dir", type=str, default="/shared/home/v_zixin_tang/dataset/HK2_crop/raw_test.npy")
    ...
    parser.add_argument("--redo_metric", type=to_bool, default=False)
    ...
    parser.add_argument("--resume_training", type=to_bool, default=1)
